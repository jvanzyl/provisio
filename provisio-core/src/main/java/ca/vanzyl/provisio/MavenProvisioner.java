...
public class MavenProvisioner {
    ...
    private Set<ProvisioArtifact> resolveArtifacts(
            ...
            List<ProvisioArtifact> artifacts,
            Set<ProvisioArtifact> managedArtifacts,
            List<ca.vanzyl.provisio.model.Exclusion> excludes) {
    ...
    private void processRuntimeActions(ProvisioningContext context) throws Exception {
        List<ProvisioningAction> runtimeActions =
